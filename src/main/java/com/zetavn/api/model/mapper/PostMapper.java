...
public class PostMapper {
    ...
    public static PostAdminDto entityToPostAdminDto(PostEntity entity) {
    ...
    public static List<PostAdminDto> entityListToAdminDtoList(List<PostEntity> entityList) {
        List<PostAdminDto> dtoList = new ArrayList<>();
        for (PostEntity entity : entityList) {
            PostAdminDto dto = entityToPostAdminDto(entity);
            dtoList.add(dto);
        }
        return dtoList;
    }
